(function ($) {
	...
	class Silence {
		...
		buildCustomElements() {
			...
			$title.html($title.html().replace(`完整的故事 | ${autherName}`, `${blogTitle}`));
			...
			let guanyu = '<ul class="sub-menu">' +
					'<li><a href=""><i class="fa fa-meetup" aria-hidden="true"></i> 我的</a></li>' +
		...
		buildCopyright() {
            ...
            Theme <a href="https://github.com/Zou-Wang/CNblogs-Theme-Sakura" target="_blank">Arlin v${this.version}</a></div>`;
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/arlenlin/" alt="Arlin~home">' +
					'<ruby><span class="sakuraso">林さん</span><span class="no">の</span><span class="shironeko">Blog</span>' +
					'<rt class="chinese-font">完整的故事</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
		...
		mainHeader() {
			...
			var header =
					...
					`       <h1 class="center-text glitch is-glitching Ubuntu-font" data-text="Hi, 林さん!">${config.title}</h1>` +
		...
		setHomeSuiBiList() {
			...
			for (let i = article_list.length - 1; i >= 0; i--) {
				...
				if (desc_img !== undefined) {
					...
					}else if(i % img_count == 1){
						url = 'https://img2020.cnblogs.com/blog/1749415/202011/1749415-20201104132308688-1373765579.jpg'
					}else if(i % img_count == 2){
						url = 'https://img2020.cnblogs.com/blog/1749415/202011/1749415-20201104132319526-1229362020.jpg'
					}else if(i % img_count == 3){
						url = 'https://img2020.cnblogs.com/blog/1749415/202011/1749415-20201104132324048-1340267001.jpg'
					}else if(i % img_count == 4){
						url = 'https://img2020.cnblogs.com/blog/1749415/202011/1749415-20201104132334307-285811115.jpg'
					}else if(i % img_count == 5){
						url = 'https://img2020.cnblogs.com/blog/1749415/202011/1749415-20201104132340033-1533711718.jpg'
					}else if(i % img_count == 6){
						url = 'https://img2020.cnblogs.com/blog/1749415/202011/1749415-20201104132347675-1112412954.jpg'
					}else if(i % img_count == 7){
						url = 'https://img2020.cnblogs.com/blog/1749415/202011/1749415-20201104132441198-1001014842.jpg'
					}
				}
				let html = `<div class="post post-list-thumb post-list-show">` +
						...
						`     <div class="post-meta"> <span><i class="iconfont icon-attention"></i>${readNum} 热度</span> <span class="comments-number"><i class="iconfont icon-mark"></i>${comNum} 条评论</span> <span><i class="iconfont icon-cc-user"></i><a href=""></a>${author}</span></div>` +
		...
		postHeader() {
			...
			if (window.location.href.indexOf('articles') === -1) {
				var header =
						`<p class="entry-census"><span><a href="https://www.cnblogs.com/arlenlin/"><img src="https://i.loli.net/2020/08/03/2DgoVKdAaJprnbw.jpg"></a></span><span><a href="https://www.cnblogs.com/arlenlin/">Arlin</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`;
